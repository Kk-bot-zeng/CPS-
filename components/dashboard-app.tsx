...
function BilibiliDashboard({ category }: { category: ProductCategory }) {
  ...
  return <>
    ...
    <div className="monitor-dashboard-shell" hidden={category !== "monitor"}>
      ...
      <iframe ref={frameRef} className="monitor-dashboard-frame" src="/monitor-dashboard/?v=20260917-metrics-drilldown" title="显示器CPS达人全链路操盘看板" scrolling="no" style={{height:frameHeight}} />
    </div>
  </>;
}
